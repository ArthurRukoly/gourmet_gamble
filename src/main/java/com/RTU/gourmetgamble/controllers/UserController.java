...
public class UserController {
    ...
    public String createUser(User user,
        ...
        if ( name.isEmpty() ){
            ...
            System.out.println("Failed to register user Error:  Name can not be empty");
            mistake = true;
        }
        ...
        if ( (password.length() < 8)||(password.length() > 30) ){
            ...
            System.out.println("Failed to register user Error:  This password must be 8-30 symbols");
            mistake = true;
        }
        ...
        if (!email.contains("@")) {
            ...
            System.out.println("Failed to register user Error:  Email should contain @");
            mistake = true;
        }
        ...
        if (!password.equals(confirmPassword)) {
            ...
            System.out.println("Failed to register user Error:  Passwords do not match");
            mistake = true;
        }
        ...
        if (!userService.createUser(user)) {
            ...
            System.out.println("Failed to register user Error:  User with this email already exists");
            mistake = true;
        }
